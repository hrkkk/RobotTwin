...
public:
    ...
    void setViewDirection(const std::string& dir)
    {
        if (dir == "front") {
            Position = glm::vec3(0.0f, 0.0f, -3.0f); // 摄像机在模型前方
            Up = glm::vec3(0.0f, 1.0f, 0.0f);
        } else if (dir == "left") {
            Position = glm::vec3(-3.0f, 0.0f, 0.0f); // 摄像机在模型左侧
            Up = glm::vec3(0.0f, 1.0f, 0.0f);
        } else if (dir == "right") {
            Position = glm::vec3(3.0f, 0.0f, 0.0f); // 摄像机在模型右侧
            Up = glm::vec3(0.0f, 1.0f, 0.0f);
        } else if (dir == "back") {
            Position = glm::vec3(0.0f, 0.0f, 3.0f); // 摄像机在模型后方
            Up = glm::vec3(0.0f, 1.0f, 0.0f);
        } else if (dir == "up") {
            Position = glm::vec3(0.0f, 3.0f, 0.0f); // 摄像机在模型上方
            Up = glm::vec3(1.0f, 0.0f, 0.0f);
        } else if (dir == "down") {
            Position = glm::vec3(0.0f, -3.0f, 0.0f); // 摄像机在模型下方
            Up = glm::vec3(1.0f, 0.0f, 0.0f);
        }
    }
